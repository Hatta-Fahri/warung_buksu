...
<head>
    ...
    <title>Status Pesanan #<?php echo $pesanan_id; ?> - Warung Kak Su</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600&display=swap" rel="stylesheet">
    <style>
        body { font-family: 'Poppins', sans-serif; }
        .status-card:hover { transform: scale(1.02); transition: all 0.3s ease; }
    </style>
</head>
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                ...
                switch ($status) {
                    case 'Menunggu Verifikasi':
                        $icon = 'fa-clock'; $bgColor = 'bg-yellow-100'; $textColor = 'text-yellow-800';
                        $message = 'Pesanan Anda sedang menunggu verifikasi oleh admin.';
                        break;
                    case 'Diproses':
                        $icon = 'fa-utensils'; $bgColor = 'bg-blue-100'; $textColor = 'text-blue-800';
                        $message = 'Pesanan Anda telah diverifikasi dan sedang disiapkan oleh dapur.';
                        break;
                    case 'Selesai':
                        $icon = 'fa-check-circle'; $bgColor = 'bg-green-100'; $textColor = 'text-green-800';
                        $message = 'Pesanan Anda telah selesai dan akan diantar ke meja Anda.';
                        break;
                    case 'Dibatalkan':
                        $icon = 'fa-times-circle'; $bgColor = 'bg-red-100'; $textColor = 'text-red-800';
                        $message = 'Pesanan Anda dibatalkan.';
                        break;
                    case 'Menunggu Pembayaran':
                        $icon = 'fa-wallet'; $bgColor = 'bg-gray-100'; $textColor = 'text-gray-800';
